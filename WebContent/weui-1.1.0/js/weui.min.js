	...
	return function(e) {
		...
		function o() {
			function e() {
				...
				a.addClass("weui-animate-fade-out"), o.addClass("weui-animate-fade-out").on("animationend webkitAnimationEnd", function() {
					i.remove(), f = !1, e()
				})
			}
			...
			if (!f) {
				...
				return d.append(i), a.addClass("weui-animate-fade-in"), o.addClass("weui-animate-fade-in"), i.on("click", ".weui-dialog__btn", function(n) {
					...
					e(function() {
						t.buttons[o].onClick && t.buttons[o].onClick.call(i, n)
					})
				}), i.hide = e, i
			}
		}
		...
		var r = n(4),
			...
			l = n(5),
			d = i(l);
		o.call(d["default"], navigator.userAgent), (0, u["default"])(d["default"].fn, {
			append: function(e) {
		...
		function o() {
			...
			o && (i = t), i = u["default"].extend({
				content: e,
				className: "",
				buttons: [{
					label: "取消",
					type: "default",
					onClick: o ? u["default"].noop : n
				}, {
					label: "确定",
					type: "primary",
					onClick: o ? u["default"].noop : t
				}]
			}, i), (0, d["default"])(i)
		}
		Object.defineProperty(t, "__esModule", {
		...
		function o() {
			...
			if (!f) {
				...
				var n = (0, r["default"])(r["default"].render(l["default"], {
					content: e
				}));
				d.append(n), n.addClass("weui-animate-fade-in"), setTimeout(function() {
					n.addClass("weui-animate-fade-out").on("animationend webkitAnimationEnd", function() {
						n.remove(), f = !1, t.callback()
					})
				}, t.duration)
			}
		}
		...
		function o() {
			function e() {
				a.addClass(i ? "weui-animate-fade-out" : "weui-animate-slide-down"), u.addClass("weui-animate-fade-out").on("animationend webkitAnimationEnd", function() {
					o.remove(), f = !1
				})
			}
			var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
			...
			if (!f) {
				...
				var i = r["default"].os.android,
					o = (0, r["default"])(r["default"].render(l["default"], {
						menus: t,
						actions: n,
						isAndroid: i
					})),
		...
		function o(e) {
			...
			return d.append(i), f && (clearTimeout(f.timeout), f.hide()), f = {
				hide: t
			}, f.timeout = setTimeout(t, n.duration), i.hide = t, i
		}
		Object.defineProperty(t, "__esModule", {
			value: !0
		});
		...
		function o(e, t) {
			...
			function i(e) {
				e.url = a.createObjectURL(e), t.onQueued(e), (0, c["default"])(r["default"].extend({
					$uploader: o,
					file: e
				}, t))
			}
			...
			t = r["default"].extend({
				...
				var e = t.onQueued;
				t.onQueued = function(t) {
					e.call(t) || o.find('[data-id="' + t.id + '"]').css({
						backgroundImage: 'url("' + (t.base64 || t.url) + '")'
					})
				}
			...
			}(), o.find("input").on("change", function(e) {
				var n = e.target.files;
				0 !== n.length && (t.compress === !1 && "file" == t.type ? Array.prototype.forEach.call(n, function(e) {
					e.id = ++s, t.onBeforeQueued(e) !== !1 && i(e)
				}) : Array.prototype.forEach.call(n, function(e) {
					e.id = ++s, t.onBeforeQueued(e) !== !1 && (0, d.compress)(e, t).then(function(e) {
						e && i(e)
					})
				}), this.value = "")
			})
		...
		e.exports = '<li class="weui-uploader__file weui-uploader__file_status" data-id="<%= id %>"> <div class=weui-uploader__file-content>0%</div> </li> '
	}, function(e, t) {
		"use strict";
			...
			return new Promise(function(o) {
				...
				a.onload = function(a) {
					...
					r.onload = function() {
						...
						else /;base64,null/.test(p) || /;base64,$/.test(p) ? (t.onError(e, new Error("Compress fail, dataURL is " + p + ".")), o()) : (e.base64 = p, o(e))
		...
		Object.defineProperty(t, "__esModule", {
			value: !0
		}), t.detectVerticalSquash = n, t.dataURItoBlob = i, t.compress = o
	}, function(e, t) {
		"use strict";
		...
		function n(e) {
			...
			n.xhr = p, s.append("name", l), s.append("type", d), s.append("lastModifiedDate", c), "file" == e.type ? (s.append("size", f), s.append(o, n, l)) : (s.append("size", n.base64.length), s.append(o, n.base64)), Object.keys(i).forEach(function(e) {
				s.append(e, i[e])
				...
				if (4 == p.readyState)
					if (200 == p.status) try {
						...
						r(n, t)
					} else r(n, new Error("XMLHttpRequest response status is not 200"))
			}, p.upload.addEventListener("progress", function(e) {
				if (0 != e.total) {
					var t = 100 * Math.ceil(e.loaded / e.total);
					a(n, t)
				}
			}, !1), p.open("POST", t), p.send(s)
		}
		Object.defineProperty(t, "__esModule", {
			value: !0
		...
		function a() {
			function e(t, n) {
				r.find(".weui-picker__group").eq(n).scroll({
					items: t,
					temp: a[n],
					onChange: function(t, u) {
						t ? o[n] = t.value : o[n] = null, a[n] = u, t.children && t.children.length > 0 ? (r.find(".weui-picker__group").eq(n + 1).show(), e(t.children, n + 1)) : (o[n + 1] = null, o.length = n + 1, r.find(".weui-picker__group").eq(n + 1).hide(), i.onChange(o))
					},
			...
			if (!m) {
				...
				return r.find(".weui-picker__bd").html(d), _(r), e(t, 0), r.on("click", ".weui-mask", function() {
					w(r)
		...
		function r(e) {
			for (var t = l["default"].extend({
				...
				}, e), n = [], i = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], o = t.start; o <= t.end; o++) {
				var r = [];
		...
		var d = n(26),
			...
			_ = function(e) {
				h.append(e), l["default"].getStyle(e[0], "transform"), e.find(".weui-mask").addClass("weui-animate-fade-in"), e.find(".weui-picker").addClass("weui-animate-slide-up")
			},
			w = function(e) {
		...
		a["default"].fn.scroll = function(e) {
			...
			if (null !== n.temp && n.temp < n.items.length) {
				var _ = n.temp;
				n.onChange.call(this, n.items[_], _), h = (n.offset - _) * n.rowHeight
			} else {
				var w = l(n.items);
			...
			o = (0, a["default"])(this).offAll().on("touchstart", function(e) {
				s = e.changedTouches[0].pageY, v = +new Date
			}).on("touchmove", function(e) {
				p = e.changedTouches[0].pageY;
				var t = p - s;
				r(o, 0), u(o, h + t), v = +new Date, m.push({
					time: v,
					y: p
		...
		t.depthOf = function n(e) {
			var t = 1;
			return e.children && e.children[0] && (t = n(e.children[0]) + 1), t
		}
	}, function(e, t) {
		...
		function o(e) {
			...
			if (!f) {
				...
				return n = r["default"].extend({
					onDelete: r["default"].noop
				}, n), d.append(i), i.find(".weui-gallery__img").on("click", t), i.find(".weui-gallery__del").on("click", function() {
					n.onDelete.call(this, e)
				}), i.show().addClass("weui-animate-fade-in"), i.hide = t, i
			}
		}
		Object.defineProperty(t, "__esModule", {
			value: !0
